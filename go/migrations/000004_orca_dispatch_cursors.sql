-- 000004_orca_dispatch_cursors.sql
-- Forward migration for ADP-05 Orca ID/cursor persistence.
-- Applied by orca.Open via embedded schema version 1; keep this file
-- byte-identical to orca.schemaSQL (minus this comment header).

CREATE TABLE orca_dispatches (
