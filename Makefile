...
clean:
	@echo Token-Stack refuses to kill host processes by name. Stop only a process you own.
...
help:
	...
	@echo make down     - Refuse unsafe process-name termination
	@echo make verify   - Show offline verifier status; use token-stack verify --live for explicit live checks
	@echo make test     - Run the hermetic Token-Stack test suite
