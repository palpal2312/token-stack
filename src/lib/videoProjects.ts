...
export const VIDEO_ROOT = path.join(AGENTIC_HOME, "video-projects");
export const RENDER_JOBS_FILE = path.join(AGENTIC_HOME, "video-render-jobs.json");
export const RENDER_LOGS_DIR = path.join(AGENTIC_HOME, "video-render-logs");
