...
// Phase 19a U0 — QA-only long-list fixture (10k-message conversation window).
...
// navigation and never a message/runtime authority — pure presentation fixture.
export default async function QaLongListPage() {
  if (process.env.AGENTIC_OS_ALLOW_TEST_FIXTURE !== "1") notFound();
  return <LongListFixture kind="conversation" />;
}