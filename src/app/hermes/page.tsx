...
type HermesTab = "chat" | "radar" | "astros" | "talk" | "apollo" | "studio" | "sessions" | "goals" | "workspace" | "mcps" | "manage" | "control" | "outreach" | "moa";
...
export default function HermesRoute() {
  ...
  useEffect(() => {
    ...
    const valid: HermesTab[] = ["chat", "radar", "astros", "talk", "apollo", "studio", "sessions", "goals", "workspace", "mcps", "manage", "control", "outreach", "moa"];
